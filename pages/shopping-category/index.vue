        ...
        <div class="row mt-30">
          <div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
            <div class="single-search-product-wrapper">
              <div class="single-search-product d-flex">
                <a href="#"
                  ><img src="~/assets/img/product/product-sm-1.png" alt=""
                /></a>
                <div class="desc">
              ...
              <div class="single-search-product d-flex">
                <a href="#"
                  ><img src="~/assets/img/product/product-sm-2.png" alt=""
                /></a>
                <div class="desc">
                  <a href="#" class="title">Gray Coffee Cup</a>
                  <div class="price">$170.00</div>
              ...
              <div class="single-search-product d-flex">
                <a href="#"
                  ><img src="~/assets/img/product/product-sm-3.png" alt=""
                /></a>
                <div class="desc">
                  <a href="#" class="title">Gray Coffee Cup</a>
                  <div class="price">$170.00</div>
          ...
          <div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
            <div class="single-search-product-wrapper">
              <div class="single-search-product d-flex">
                <a href="#"
                  ><img src="~/assets/img/product/product-sm-4.png" alt=""
                /></a>
                <div class="desc">
                  <a href="#" class="title">Gray Coffee Cup</a>
                  <div class="price">$170.00</div>
              ...
              <div class="single-search-product d-flex">
                <a href="#"
                  ><img src="~/assets/img/product/product-sm-5.png" alt=""
                /></a>
                <div class="desc">
                  <a href="#" class="title">Gray Coffee Cup</a>
                  <div class="price">$170.00</div>
              ...
              <div class="single-search-product d-flex">
                <a href="#"
                  ><img src="~/assets/img/product/product-sm-6.png" alt=""
                /></a>
                <div class="desc">
                  <a href="#" class="title">Gray Coffee Cup</a>
                  <div class="price">$170.00</div>
          ...
          <div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
            <div class="single-search-product-wrapper">
              <div class="single-search-product d-flex">
                <a href="#"
                  ><img src="~/assets/img/product/product-sm-7.png" alt=""
                /></a>
                <div class="desc">
                  <a href="#" class="title">Gray Coffee Cup</a>
                  <div class="price">$170.00</div>
              ...
              <div class="single-search-product d-flex">
                <a href="#"
                  ><img src="~/assets/img/product/product-sm-8.png" alt=""
                /></a>
                <div class="desc">
                  <a href="#" class="title">Gray Coffee Cup</a>
                  <div class="price">$170.00</div>
              ...
              <div class="single-search-product d-flex">
                <a href="#"
                  ><img src="~/assets/img/product/product-sm-9.png" alt=""
                /></a>
                <div class="desc">
                  <a href="#" class="title">Gray Coffee Cup</a>
                  <div class="price">$170.00</div>
